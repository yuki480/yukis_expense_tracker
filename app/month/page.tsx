...
function MonthStatsContent({ email }: { email: string }) {
  return (
    <div className="min-h-screen bg-blue-100">
      ...
      <div className="grid h-screen items-center justify-items-center min-w-[600px] overflow-auto min-h-screen text-gray-800 p-6">
        <h1 className="text-2xl font-bold text-blue-800 mb-6">
          in the past 30 days, you spent...
        </h1>
        <ExpenseChart range="month" email={email} />
...
function MonthStatsWrapper() {
  ...
  return <MonthStatsContent email={email} />;
}
